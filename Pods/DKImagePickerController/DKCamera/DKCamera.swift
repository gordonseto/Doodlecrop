...
open class DKCamera: UIViewController {
    ...
    open var isMessageMode: Bool = true
    ...
    open func takePicture() {
        ...
        if let stillImageOutput = self.stillImageOutput {
            ...
            DispatchQueue.global(priority: ).async(execute: {
    ...
    open func handleFocus(_ gesture: UITapGestureRecognizer) {
        ...
        } else if let currentDevice = self.currentDevice, currentDevice.isExposurePointOfInterestSupported {
            let touchPoint = gesture.location(in: self.view)
            self.exposureAtTouchPoint(touchPoint)
        }
    }
    
    fileprivate func exposureAtTouchPoint(_ touchPoint: CGPoint) { ////////////////////////////////////////////
